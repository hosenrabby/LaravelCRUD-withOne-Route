                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a
                                    href="{{ url('/user-data-information') }}"
                                    class="underline text-gray-900 dark:text-white">Laravel CRUD</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Laravel has wonderful CRUD Application with the resources routing, if you want to see
                                this crud app, then go to the link provided. Thank You
                            </div>
                        </div>
                    </div>
                </div>
